# -*- coding: utf-8 -*-
"""
STEP 17-21-C-16-8-T-34-S44
Gazette 1296 / pstSn 29471 attachment metadata forensic probe.
...
OUT = OUT_DIR / "development_density_management_area_municipal_gazette_1296_attachment_forensic.json"
...
def main() -> None:
    ...
    print("GAZETTE 1296 ATTACHMENT FORENSIC")
    print("=" * 60)
    ...
    output = {
        "step": "STEP 17-21-C-16-8-T-34-S44",
    ...
    if not all(vals.values()):
        raise AssertionError("Gazette 1296 attachment forensic validation failed")
