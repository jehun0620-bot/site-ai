...
개발밀도관리구역 FALSE overlay

입력
======================================================================
site_rule_evaluation_condition_overlay.json
    - 서울도심 FALSE까지 반영된 현재 Rule Evaluation
...
목표
======================================================================
1. 개발밀도관리구역 condition을 UNKNOWN -> FALSE로 overlay
2. 해당 조문 applicability 재평가
3. FALSE blocker 최우선
4. numeric current effect 상태 갱신
5. unresolved SITE condition 재집계
6. BCR/FAR confirmed 50 / 250 유지 검증
"""
...
def main() -> int:
    ...
    if (
        ...
        raise ValueError(
            "개발밀도관리구역 FALSE/HIGH resolution이 아님"
        )
    ...
    for rule in rules:
        ...
        for condition in rule.get(
            ...
            condition[
                ...
                "DEVELOPMENT_DENSITY_MANAGEMENT_EVIDENCE_RESOLUTION"
            )
