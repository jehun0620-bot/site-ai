...
DISTRICT_UNIT_PLAN_CONDITION_NAME = "지구단위계획"
...
_DISTRICT_UNIT_PLAN_PROFILE = RegulationResolutionProfile(
    name=DISTRICT_UNIT_PLAN_CONDITION_NAME,
    condition_type="SITE",
    resolution_type="HYBRID_SPATIAL_NOTICE",
    standard_code=None,
...
_BUILTIN_PROFILES = MappingProxyType(
    {
        ...
        _DISTRICT_UNIT_PLAN_PROFILE.name: _DISTRICT_UNIT_PLAN_PROFILE,
