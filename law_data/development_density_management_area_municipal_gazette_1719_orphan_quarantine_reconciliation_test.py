# -*- coding: utf-8 -*-
"""S61: quarantine Gazette 1719 / pstSn 221174 as an isolated attachment metadata orphan."""
...
TOPO=OUTDIR/'development_density_management_area_municipal_gazette_1719_attachment_topology_probe.json'
OUT=OUTDIR/'development_density_management_area_municipal_gazette_1719_orphan_quarantine_reconciliation.json'
TARGET='221174'
...
def main():
    print('='*60); print('GAZETTE 1719 ORPHAN QUARANTINE RECONCILIATION - S61'); print('='*60)
    ...
    output={
        'step':'STEP 17-21-C-16-8-T-34-S61','target_pstSn':TARGET,
    ...
    vals={
        ...
        'quarantine count five':state['quarantined_count']==5,
        'candidate count zero':state['candidate_count']==0,
        'unresolved equals quarantine only':state['unresolved_count']==5 and len(unknown)==0,
    ...
    if not all(vals.values()): raise AssertionError('Gazette 1719 quarantine reconciliation failed')
