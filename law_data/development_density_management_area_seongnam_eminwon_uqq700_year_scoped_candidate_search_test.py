...
OUT = BASE / "law_data" / "output" / "development_density_management_area_seongnam_eminwon_uqq700_year_scoped_candidate_search.json"
...
# Initial bounded historical tranche. Extend only after reviewing this result.
...
def main() -> None:
    print("=" * 60)
    print("SEONGNAM EMINWON UQQ700 YEAR-SCOPED CANDIDATE SEARCH - S154")
    print("=" * 60)
    ...
    if technical:
        semantic = "SEONGNAM_EMINWON_YEAR_SCOPED_UQQ700_SEARCH_TECHNICAL_UNKNOWN"
    elif direct or related:
        semantic = "SEONGNAM_EMINWON_YEAR_SCOPED_UQQ700_HIGH_SIGNAL_CANDIDATE_FOUND"
    elif candidates:
        semantic = "SEONGNAM_EMINWON_YEAR_SCOPED_UQQ700_SEARCH_RESULT_CANDIDATES_FOUND"
    else:
        semantic = "SEONGNAM_EMINWON_YEAR_SCOPED_UQQ700_NO_CANDIDATE_IN_INITIAL_HISTORICAL_TRANCHE"

    out = {
        "step": "STEP 17-21-C-16-8-T-50-S154",
    ...
    if not all(checks.values()):
        raise AssertionError("S154 year-scoped UQQ700 candidate search failed")
