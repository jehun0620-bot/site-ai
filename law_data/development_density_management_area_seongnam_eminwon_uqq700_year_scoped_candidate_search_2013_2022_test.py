...
OUT = BASE / "law_data" / "output" / "development_density_management_area_seongnam_eminwon_uqq700_year_scoped_candidate_search_2013_2022.json"
...
def main() -> None:
    print("=" * 60)
    print("SEONGNAM EMINWON UQQ700 YEAR-SCOPED CANDIDATE SEARCH 2013-2022 - S155")
    print("=" * 60)
    ...
    if technical:
        semantic = "SEONGNAM_EMINWON_2013_2022_UQQ700_SEARCH_TECHNICAL_UNKNOWN"
    elif direct or related:
        semantic = "SEONGNAM_EMINWON_2013_2022_UQQ700_HIGH_SIGNAL_CANDIDATE_FOUND"
    elif candidates:
        semantic = "SEONGNAM_EMINWON_2013_2022_UQQ700_SEARCH_RESULT_CANDIDATES_FOUND"
    else:
        semantic = "SEONGNAM_EMINWON_2013_2022_UQQ700_NO_CANDIDATE_IN_BOUNDED_SEARCH_SURFACE"

    out = {
        "step": "STEP 17-21-C-16-8-T-51-S155",
    ...
    if not all(checks.values()):
        raise AssertionError("S155 year-scoped UQQ700 candidate search 2013-2022 failed")
