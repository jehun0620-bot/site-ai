# -*- coding: utf-8 -*-
"""S60: attachment topology probe for Gazette 1719 / pstSn 221174."""
...
OUT=OUTDIR/'development_density_management_area_municipal_gazette_1719_attachment_topology_probe.json'
TARGET='221174'
WINDOW=3
...
def main():
    print('='*60); print('GAZETTE 1719 ATTACHMENT TOPOLOGY PROBE - S60'); print('='*60)
    ...
    payload={'step':'STEP 17-21-C-16-8-T-34-S60','target_pstSn':TARGET,'rows':findings,'summary':summary,'attachment_body_downloaded':False,'state_mutation_executed':False,'negative_evidence_allowed':False,'site_positive_allowed':False,'site_negative_allowed':False,'runtime_registration_allowed':False}
    ...
    if not all(vals.values()): raise AssertionError('Gazette 1719 topology validation failed')
